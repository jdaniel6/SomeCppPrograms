/**
 * @file Daniel_Jeffrey_HW2AUI.cc
 * @author Jeffrey Daniel (jdaniel6@stevens.edu)
 * @brief An interactive program to print the NOAA windchill table as provided in https://www.weather.gov/safety/cold-wind-chill-chart , as updated on 2nd September 2022.
 * @version 0.1
 * @date 2022-09-03
 * 
